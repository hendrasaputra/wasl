...
UI = {
 ...
 "hero":        {"en": "The Prophet's family, the Companions and the Arab tribes — every link traced to the page that attests it.",
                 "id": "Keluarga Nabi, para Sahabat dan kabilah Arab — setiap tautan ditelusuri ke halaman yang menyebutkannya.",
                 "ms": "Keluarga Nabi, para Sahabat dan kabilah Arab — setiap pautan ditelusuri ke halaman yang menyebutnya."},
 "start":       {"en": "Start with a person", "id": "Mulai dari seorang tokoh", "ms": "Mula dengan seorang tokoh"},
 "try":         {"en": "Try", "id": "Coba", "ms": "Cuba"},
 "how":         {"en": "How it is checked", "id": "Bagaimana ini diperiksa", "ms": "Bagaimana ia disemak"},
 "how_1":       {"en": "Every name, link and second name is a quotation from a named critical edition, with volume and page.",
                 "id": "Setiap nama, tautan dan nama lain adalah kutipan dari edisi kritis yang disebutkan, dengan jilid dan halaman.",
                 "ms": "Setiap nama, pautan dan nama lain ialah petikan daripada edisi kritis yang dinamakan, dengan jilid dan halaman."},
 "how_2":       {"en": "Before this page is published, a script re-reads every cited page and fails if the Arabic is not there.",
                 "id": "Sebelum halaman ini diterbitkan, sebuah skrip membaca ulang setiap halaman yang dikutip dan gagal jika teks Arabnya tidak ada.",
                 "ms": "Sebelum halaman ini diterbitkan, satu skrip membaca semula setiap halaman yang dipetik dan gagal jika teks Arabnya tiada."},
 "how_3":       {"en": "Where the books disagree, every reading is kept and shown. No date is ever guessed.",
                 "id": "Bila kitab-kitab berbeda, setiap bacaan disimpan dan ditampilkan. Tidak ada tanggal yang ditebak.",
                 "ms": "Apabila kitab-kitab berbeza, setiap bacaan disimpan dan dipaparkan. Tiada tarikh yang diteka."},
 "thread":      {"en": "Line of descent", "id": "Garis nasab", "ms": "Garis nasab"},
 "fold_n":      {"en": "{n} generations folded — show them", "id": "{n} generasi dilipat — tampilkan",
                 "ms": "{n} generasi dilipat — paparkan"},
 "fold_back":   {"en": "fold the line", "id": "lipat kembali", "ms": "lipat semula"},
 "no_father":   {"en": "no father recorded in these books", "id": "tidak ada ayah tercatat dalam kitab-kitab ini",
                 "ms": "tiada bapa direkodkan dalam kitab-kitab ini"},
 "edge_src":    {"en": "{n} sources for this link", "id": "{n} sumber untuk tautan ini", "ms": "{n} sumber untuk pautan ini"},
 "brief":       {"en": "In brief", "id": "Ringkasnya", "ms": "Ringkasnya"},
 "brief_note":  {"en": "Drawn only from this person's own entry in {w}; every sentence rests on a phrase of the Arabic, re-read before publishing.",
                 "id": "Diambil hanya dari entri tokoh ini dalam {w}; setiap kalimat bersandar pada frasa Arab yang dibaca ulang sebelum diterbitkan.",
                 "ms": "Diambil hanya daripada entri tokoh ini dalam {w}; setiap ayat bersandar pada frasa Arab yang dibaca semula sebelum diterbitkan."},
 "family":      {"en": "Family", "id": "Keluarga", "ms": "Keluarga"},
 "books_say":   {"en": "What the books say", "id": "Apa kata kitab-kitab", "ms": "Apa kata kitab-kitab"},
 "open_tree":   {"en": "Open the whole tree", "id": "Buka seluruh pohon", "ms": "Buka seluruh pokok"},
 "home":        {"en": "Home", "id": "Beranda", "ms": "Laman utama"},
 "more":        {"en": "+{n} more", "id": "+{n} lagi", "ms": "+{n} lagi"},
 "gen_n":       {"en": "gen. {n}", "id": "gen. {n}", "ms": "gen. {n}"},
 "dir_intro":   {"en": "Start with a name. Read who they were, then follow their line.",
                 "id": "Mulailah dari sebuah nama. Baca siapa dia, lalu telusuri nasabnya.",
                 "ms": "Mulakan dengan sebuah nama. Baca siapa dia, kemudian telusuri nasabnya."},
 "g_lineage":   {"en": "Lineage", "id": "Nasab", "ms": "Nasab"},
 "evidence":    {"en": "Sources for this person", "id": "Sumber untuk tokoh ini",
                 "ms": "Sumber bagi tokoh ini"},
 "view_filter": {"en": "View & filter", "id": "Tampilan & saring", "ms": "Paparan & tapis"},
 "more_n":      {"en": "{n} more", "id": "{n} lagi", "ms": "{n} lagi"},
